...
class DebugAnalysisWave(QWidget):
    ...
    def linePlot1(self):
        ...
        p1.setLabel(axis='bottom', text='x / time')
        p1.setTitle('DAW - p1')  # 表格的名字
        curve1 = p1.plot()  # 绘制一个图形
        curve1.setData(data)
    ...
    def linePlot3(self):
        ...
        p3.setLabel(axis='bottom', text='x / time')
    ...
    def linePlot4(self):
        ...
        p4.setLabel(axis='bottom', text='x / time')
    ...
    def linePlot5(self):
        ...
        p5.setLabel(axis='bottom', text='x / time')
